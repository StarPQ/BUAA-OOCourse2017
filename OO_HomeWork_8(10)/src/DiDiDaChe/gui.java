...
class myform extends JFrame {// 我的窗体程序
	...
	public myform() {
		...
		button1.setBounds(10, 1415, 100, 40);// 设置按钮的位置
		...
		button2.setBounds(120, 1415, 100, 40);// 设置按钮的位置
		...
		button3.setBounds(230, 1415, 100, 40);// 设置按钮的位置
		...
		button4.setBounds(340, 1415, 100, 40);
		...
		check1.setBounds(450, 1415, 80, 40);
		...
		check2.setBounds(530, 1415, 80, 40);
		...
		drawboard.setBounds(10, 10, 1400, 1400);// 设置大小
