...
public class Request extends Thread{
	public Request(myPoint Pos, myPoint Dst,String REQ, int t, JackMa Scheduler){
		...
		@ EFFECTS: 初始化taxi， REQ， Pos， Dst，t，Scheduler
		*/
	...
	private void chooseTaxi(){
		/* 
		@ REQUIRES: 出租车队列已经按照信用值排序
		@ MODIFIES: TarTaxi
		@ EFFECTS: 	在taxi队列中选择接单的出租车
	...
	private void startService(){
		...
		*/
		...
		while(dis>0){
			...
			pos = next;
			dis = minDis;
			//System.out.println(this.TarTaxi.getName()+" "+minDis);
	...
	public boolean equals(Object obj) {
		...
		@ MODIFIES: None
		@ EFFECTS: 若指令发出时间相同，发出位置相同，目的地相同，则返回true，否则返回false
		*/
